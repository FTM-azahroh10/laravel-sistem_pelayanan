...
@endsection
@section('content')
<h4 style="color: #1d2951; margin-left: 65px">Services > <span style="color: orange">Academic Services</span></h4>
<div id="actions" style="background-color: #243364; padding: 10px 15px" class="d-flex justify-content-between">
    <div class="main-header ">
        <h3 style="color: white">Edit Academic Service</h3>
    </div>
</div>

<div class="container bg-white p-4">
    <form action="/academic-services/{{$data->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="mb-3">
        ...
        {{-- <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" required name="keperluan">
                <option selected value="">Pilih Keperluan</option>
        ...
        <div class="mb-3">
            <label for="keperluan" class="form-label">Keperluan</label>
            <input type="keperluan" class="form-control" id="keperluan" name="keperluan" value="{{old('keperluan',$data->keperluan)}}" required>
        </div>
