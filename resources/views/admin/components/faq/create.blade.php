...
@endsection
@section('content')
<h4 style="color: #1d2951; margin-left: 65px">Frequently Asked Questions (FAQ’s) ></h4>
<div id="actions" style="background-color: #243364; padding: 10px 15px" class="d-flex justify-content-between">
    <div class="main-header ">
        <h3 style="color: white">Create Frequently Asked Questions (FAQ’s)</h3>
    </div>
</div>
...
<div class="container bg-white p-4">
    <form action="/faq" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="jawaban" name="jawaban" value="{{old('jawaban')}}" required>
        </div>
