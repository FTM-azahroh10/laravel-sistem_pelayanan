...
@endsection
@section('content')
<h4 style="color: #1d2951; margin-left: 65px">Services > <span style="color: orange">Student Services</span></h4>
<div id="actions" style="background-color: #243364; padding: 10px 15px" class="d-flex justify-content-between">
    <div class="main-header ">
        <h3 style="color: white">Edit Student Service</h3>
    </div>
</div>

<div class="container bg-white p-4">
    <form action="/student-services/{{$data->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="mb-3">
