...
@section('content')
    ...
    <div class="centered-container">
        <div class="border-box">
            <div class="container">
                <p style="text-align: center; font-weight: bold; font-size: 35px; color: #1d2951">Submission of Student
                    Activities</p>
                <div class="row">
                    <!-- Upload Section -->
                    <div class="col-md-12" id="iconmenu">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="/activitiesUpload" class="card align-items-center text-center">
                                    <div class="row pt-4">
                            ...
                            <!-- Queue Section -->
                            <div class="col-md-6">
                                <a href="/activitiesStatus" class="card align-items-center text-center">
                                    <div class="row pt-4">
                                        <div class="col-md-6 d-flex justify-content-center align-items-center">
