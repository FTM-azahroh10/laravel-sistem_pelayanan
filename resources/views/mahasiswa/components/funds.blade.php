...
@section('content')
    ...
    <div class="centered-container">
        <div class="border-box">
            <div class="container">
                <p style="text-align: center; font-weight: bold; font-size: 35px; color: #1d2951">
                    Submision of<br />
                    for Student Affairs <Activities></Activities>
                </p>
                <div class="row">
                    <!-- Upload Section -->
                    <div class="col-md-12" id="iconmenu">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="/fundsUpload" class="card align-items-center text-center">
                                    <div class="row pt-4">
                            ...
                            <!-- Queue Section -->
                            <div class="col-md-6">
                                <a href="/fundsStatus" class="card align-items-center text-center">
                                    <div class="row pt-4">
                                        <div class="col-md-6 d-flex justify-content-center align-items-center">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12 d-flex align-items-center">
                                <a href="/fundsQueue" class="card align-items-center text-center mx-auto"
                                    style="width: 350px">
                                    <div class="row pt-4">
                                        <div class="col-md-6 d-flex justify-content-center align-items-center">
