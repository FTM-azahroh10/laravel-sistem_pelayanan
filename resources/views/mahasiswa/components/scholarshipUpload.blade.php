...
@section('content')
    ...
    <div class="card" style="background-color: #edab2d; height: 420px">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="pt-2 mb-4">Scholarship Application</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 d-flex">
                    <div class="card d-flex align-items-center ms-4 text-center"
                        ...
                        <br />
                        <ol>
                            <li align="left">Kartu Tanda Penduduk (KTP)</li>
                            <li align="left">Kartu Tanda Mahasiswa</li>
                            <li align="left">Surat Penerimaan/Keterangan Lulus/LoA Unconditional dari Perguruan Tinggi.
                            </li>
                            <li align="left">Surat Keterangan Aktif Kuliah yang diterbitkan oleh Perguruan Tinggi.</li>
                        </ol>
                    </div>
                </div>
