...
@section('content')
    ...
    <div class="card" style="background-color: #edab2d; height: 420px">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="pt-2 mb-4">Submission Of Resignation</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 d-flex">
                    <div class="card d-flex align-items-center ms-4 text-center"
                        ...
                        <br />
                        <ol>
                            <li align="left">Permohonan Pengunduran Diri Sebaga Mahasiswa</li>
                            <li align="left">Bukti Rekap Pembayaran GAPURA di Bagian Keuangan.</li>
                            <li align="left">Transkrip Akademik./li></li>
                            <li align="left">Surat Keterangan Persetujuan Orang Tua/Wali Mahasiswa (Penanggung Biaya)/li>
                            </li>
                            <li align="left">Surat Keterangan Persetujuan dari Pimpinan/Instansi Asal /li></li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="container row d-flex justify-content-center">
                            <div class="custom-file" style="width: 500px; text-align: center; padding-top: 50px">
                                ...
                                <form action="{{ route('fileupload.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input class="" type="hidden" id="formFile" name="other_field" value="RSG"/>
