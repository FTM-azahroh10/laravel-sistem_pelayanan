...
@section('content')
    ...
    <div class="card" style="background-color: #edab2d; height: 420px">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="pt-2 mb-4">UKT AID Aplication</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 d-flex">
                    <div class="card d-flex align-items-center ms-4 text-center"
                        ...
                        <br />
                        <ol>
                            <li align="left">Surat Keterangan Pekerjaan orang tua/ penanggung jawab biaya kuliah dari
                                kepala desa/lurah.</li>
                            <li align="left">Surat PHK (jika ada)</li>
                            <li align="left">Surat Pernyataan (bermaterai)</li>
                            <li align="left">Kartu Keluarga</li>
                        </ol>
                    </div>
                </div>
